...
scaler_model = pickle.load(open(r'models\model_scaler.pkl','rb'))
logistic_model = pickle.load(open(r'models\model_lr.pkl','rb'))
dtc_model = pickle.load(open(r'models\model_dtc.pkl','rb'))
